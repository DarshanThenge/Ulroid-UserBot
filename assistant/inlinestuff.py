...
async def repo(e):
    res = [
        await e.builder.article(
            title="Русская девушка 🇷🇺",
            description="Userbot | Robot,",
            thumb=wb(ultpic, 0, "https://telegra.ph/file/5af007733ce6147709980.jpg,", []),
            text="• Русская девушка 🇷🇺,,, •",
            buttons=[
                [
                    Button.url("Repo", url="https://github.com"),
                    Button.url(
                        "Addons", url="https://github.com/"
                    ),
                ],
                [Button.url("Support", url="t.me/,")],
            ],
        ),
    ]
