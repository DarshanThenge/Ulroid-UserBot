...
__UserRobot {ultroid_version}, powered by Русская девушка 🇷🇺__
"""
    ...
    if event.is_group and event.sender_id in sed:
        ...
        if not udB.get("STARTMSG"):
            if udB.get("PMBOT") == "True":
                ok = "You can contact my owner using this bot!!\n\nSend your Message, I will Deliver it To her."
            await event.reply(
                f"Hey there [{get_display_name(u)}](tg://user?id={u.id}), this is UserRobot Assistant of [{ultroid_bot.me.first_name}](tg://user?id={ultroid_bot.uid})!\n\n{ok}",
